...
# 4. Go to the project folder inside the terminal
cd C:\path\to\project\folder

# 5. Create a project configuration
cmake -S . -B build
...
**Q: What is a calculator?**  
A: A calculator is typically a portable electronic device used to perform calculations, ranging from basic arithmetic to complex mathematics.
